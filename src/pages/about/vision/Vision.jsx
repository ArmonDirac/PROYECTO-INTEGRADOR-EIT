...
import valuesImage from "@/public/images/about/mission.jpg";
...
const Vision = () => {
    ...
    return (
        <section className="vision">
            ...
            <div>
                <img className="vision__image" src={"./src/public/images/about/vision.jpg"} alt="Imagen de la visión de la empresa"/>
